    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppRoleFeatures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppRoleFeatures_AppFeatures_AppFeatureId",
                        column: x => x.AppFeatureId,
                        principalTable: "AppFeatures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppRoleFeatures_AppRoles_AppRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Omega = table.Column<float>(nullable: false),
                    W = table.Column<int>(nullable: false),
                    R = table.Column<int>(nullable: false),
                    KvisRange = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Seas_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeaId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Isles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Isles_Seas_SeaId",
                        column: x => x.SeaId,
                        principalTable: "Seas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedOn = table.Column<DateTime>(nullable: false),
                    Omega = table.Column<float>(nullable: false),
                    Amplitude = table.Column<double>(nullable: false),
                    Row = table.Column<int>(nullable: false),
                    Column = table.Column<int>(nullable: false),
                    SeaId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Oscillators_Seas_SeaId",
                        column: x => x.SeaId,
                        principalTable: "Seas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppRoleFeatures_AppFeatureId",
                table: "AppRoleFeatures",
                column: "AppFeatureId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRoleFeatures_AppRoleId",
                table: "AppRoleFeatures",
                column: "AppRoleId");
